...
export default function UploadFileDialog({ open  ,onOpenChange, onFileUploaded}: Props) {
  ...
  return (
    <Dialog onOpenChange={onOpenChange} open={open}>
      <DialogContent className={"sm:max-w-lg"}>
        ...
        <DialogFooter>
          <Button disabled={isUploading} variant={"outline"} onClick={handleCancel}>Cancel</Button>
          <Button
