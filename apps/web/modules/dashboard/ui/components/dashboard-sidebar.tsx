              ...
              <OrganizationSwitcher
                ...
                appearance={{
                  elements: {
                    ...
                    organizationSwitcherTrigger: "w-full! justify-start! p-2! group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2!",
                    organizationPreview: "group-data-[collapsible=icon]:justify-center! gap2!",
