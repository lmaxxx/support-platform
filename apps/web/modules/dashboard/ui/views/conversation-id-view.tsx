...
import ConversationsStatusButton from "@/modules/dashboard/ui/components/conversations-status.button";
          ...
          <AIInput onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <AIInputToolbar>
              <AIInputTools>
                ...
                >
                  {isEnhancing ? <LoaderIcon className={"animate-spin"}/> : <Wand2Icon/>}
